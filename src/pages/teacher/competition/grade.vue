        ...
        <el-dialog
            ...
            <div class="dialog-wapper">
                ...
                <div class="fen-wapper fen-table-w">
                    ...
                    <div class="fuj">
                        附件：<a target='blank' :href="$api.serverUrl+'/'+scoremodel.url">{{scoremodel.urlName}}</a>
                    </div>
                </div>
                </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        getList(){
            ...
            this.$api.Competition.getScoreResultList(params).then(res=>{
        ...
        exportData(){
            ...
            if(this.mainData.length==0){
                ...
                window.location.href=`${this.$api.serverUrl}/Competition/ExportExcelScoreResult?ResultName=${params.ResultName}&SubjectId=${params.SubjectId}&UserId=${params.UserId}&pageSize=${params.pageSize}&pageIndex=${params.pageIndex}`
            }
        ...
        getTest(item){
            ...
            this.$api.Competition.getScoreTreeList(params).then(res=>{
               console.log(res.data)
        ...
        treSave(){
            ...
            this.$api.Competition.updatecore(this.gradeList).then(res=>{
                if(res.data.success){
                    console.log(res.data)
        ...
        delSave(){
            let that=this;
            this.$api.Competition.deleteScoreresult(this.setData.scoreResultId).then(res=>{
               console.log(res.data)
               if(res.data.success){
